                   ...
                   <div className="row-view a-start mg-t-15">
                     ...
                     <div className='col-view mg-l-10 w-100'>
                       <div className='row-view sb-view'>
                         <span className='ft-sz-16'>Royalty Income</span>
                         <span className='ft-sz-16 cl-orange'>₹20000</span>
                       </div>
                       
                       <div className='col-view mg-t-10'>
                        <span className='w-80-p pd-5-10 ft-sz-13 br-10 bg-l-white'>Team: 100</span>

                        <div className='ft-sz-13 mg-t-10'>
                            When you complete 100 active refers then you will get ₹20000 within 1 month.
                        </div>
                       </div>
                     </div>
                   </div>
