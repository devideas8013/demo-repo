...
<title>Admin: User Investments</title>
...
<div class="main">
  ...
  <h2><i class='bx bx-grid-alt'></i>&nbsp;User Investments</h2>
  ...
  <table id="data">
    ...
    <?php
      if($searched!=""){
        $sql = "SELECT * FROM myinvestments where uniq_id like '%$searched%' or investment_name like '%$searched%' ";
      }else{
        $sql = "SELECT * FROM myinvestments ORDER BY id DESC LIMIT {$offset},{$content}";
      }
	...
	<div class="item">
    <?php
      $sql1 = "SELECT * FROM myinvestments";
