<?php
  ...
  $API_TARGET_URL = "https://".$SERVER_URL."/pg/utrpay-58745/";
      ...
      <div class="pg-view">
        ...
        <div class="payment-start-view ">
          ...
          <div class="payment-option">
            ...
            <button class="pay-option-btn" data-val="paytm">Pay</button>
          </div>
          ...
          <div class="payment-option">
            ...
            <button class="pay-option-btn" data-val="phonepe">Pay</button>
          </div>
        ...
        <div class="payment-success-dialog hide_view">
          ...
          <p id="payment-status-tv">Payment Submitted</p>
